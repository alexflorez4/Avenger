...
module.exports = {
	...
	modes: {
		...
		/**
		 * Point mode returns all elements that hit client based on the event position
		 * of the event
		...
		/**
		 * x mode returns the elements that hit-client at the current x coordinate
		...
		/**
		 * y mode returns the elements that hit-client at the current y coordinate
...
var helpers = {
	 ...
	 * @param {*} value - The value to client.
	 * @returns {Boolean}
	 * @since 2.7.0
	 */
