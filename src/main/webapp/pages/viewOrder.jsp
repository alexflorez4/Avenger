        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-5 bottom-buffer">
                    ...
                    <form role="form" method="post" action="updateOrder.do" id="orderForm">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" autocomplete="off" id="reference" name="reference" value="${order.orderId}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" id="bApt" name="bApt" value="${order.other}">
                            </div>
                        </div>
