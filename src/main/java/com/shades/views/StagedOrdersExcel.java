...
public class StagedOrdersExcel extends AbstractXlsxView {
    ...
    protected void buildExcelDocument(Map<String, Object> map, Workbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        header.createCell(11).setCellValue("Tracking No");
        header.createCell(12).setCellValue("Shipping Cost");
        ...
        for(OrderEntity next : orders){
            ...
            orderRow.createCell(5).setCellValue(next.getStreet2());
            ...
            orderRow.createCell(10).setCellValue(ParseAmzOrder.EnumSuppliers.getSupplierName(next.getSupplierId()));
        }
    }
}
